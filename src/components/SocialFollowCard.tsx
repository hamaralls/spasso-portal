    ...
    <div className="bg-white border border-gray-100 rounded-xl p-4">
      ...
      <div className="flex flex-col gap-2">
        <a
          ...
          className="flex items-center gap-2.5 px-3 py-2 rounded-lg bg-[#1877F2] text-white hover:bg-[#0d6de0] transition-colors text-sm font-semibold"
        >
        ...
        <a
          ...
          target="_blank"
          rel="noopener noreferrer"
          className="flex items-center gap-2.5 px-3 py-2 rounded-lg text-white hover:opacity-90 transition-opacity text-sm font-semibold"
