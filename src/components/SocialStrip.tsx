// Barra social fina acima do header — desktop only, não sticky (rola com a página)
export default function SocialStrip() {
  return (
    <div className="bg-[#111] text-white hidden lg:block">
      <div className="max-w-7xl mx-auto px-4 flex items-center justify-end gap-5 h-8">
        <span className="text-[10px] text-white/40 tracking-widest uppercase mr-1">Siga-nos</span>
